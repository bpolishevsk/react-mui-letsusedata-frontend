...
import PageStudentDetail from "../admin/Students/StudentDetail/StudentDetail";
...
import { readQuartersList, readSchoolsList } from "../store/app.slice.js";
...
import PageCourses from "../admin/Courses/Courses.jsx";
import PageModules from "../admin/Modules/Modules.jsx";
...
function AdminRoutes() {
  ...
  React.useEffect(() => {
    ...
    dispatch(readSchoolsList());
    dispatch(readQuartersList());
  }, [dispatch]);
  ...
  return (
    <Routes>
      <Route path="/" element={<AdminMainLayout></AdminMainLayout>}>
        ...
        <Route path="courses" element={<PageCourses></PageCourses>}></Route>
        <Route path="modules" element={<PageModules></PageModules>}></Route>
        <Route path="*" element={<ErrorPage />} />
      </Route>
      <Route path="students/:studentId" element={<PageStudentDetail></PageStudentDetail>}></Route>
