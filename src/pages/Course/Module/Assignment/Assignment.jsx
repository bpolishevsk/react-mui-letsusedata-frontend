...
import InPlaceEditable from "../../../../components/in-place-editables/InPlaceEditables";
    ...
    <div className="module-content">
      <div className="step-header d-flex items-center justify-content-between">
        <div className="step-header__left">
          <InPlaceEditable.IPESimple
            Class="step-header__title"
            HtmlTag="h2"
            Text={activity?.Title}
            IPEPanelPos="absolute,top,right,out"
            Api="CodingProblem.UpdateTitle[codingProblemId=ActivityId]"
          ></InPlaceEditable.IPESimple>
        ...
        <div className="step-header__right d-flex align-items-center">
          <InPlaceEditable.IPEDateTime
            DateTime={codingProblem?.dueDate}
            IPEPanelPos="absolute,top,right,in"
            Api="CodingProblem.UpdateDuedate[codingProblemId=ActivityId,courseInstanceId]"
          ...
          <div className="grade d-flex flex-column mx-3">
            ...
            <span className="grade-value">
              ...
              <InPlaceEditable.IPESimple
                Class=""
                HtmlTag="span"
                Text={codingProblem?.Attempts}
                IPEPanelPos="float,top,right,in"
                Api="CodingProblem.UpdateMaxAttempts[codingProblemId=ActivityId]"
              ></InPlaceEditable.IPESimple>
            </span>
          </div>
          <ActivityNav
            ...
            <div className="assignment-detail">
              ...
              >
                <Tab eventKey="instructions" title="Instructions">
                  <InPlaceEditable.IPEInnerHtml
                    Class="instruction"
                    InnerHtml={codingProblem?.Instructions}
                    IPEPanelPos="float,top,right,in"
                    Api="CodingProblem.UpdateInstructions[codingProblemId=ActivityId]"
                  ></InPlaceEditable.IPEInnerHtml>
                </Tab>
