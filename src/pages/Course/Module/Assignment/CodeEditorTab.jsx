...
function CodeEditorTab({ codingProblem, RunCodeResult, onSubmit }) {
  ...
  React.useEffect(() => {
    setScript(codingProblem.Script);
  }, [codingProblem.Script]);
      ...
      <Tabs defaultActiveKey="home" transition={false}>
        <Tab eventKey="home" title="main.cpp">
          <div className="code-editor">
            ...
            <InPlaceEditable.IPEAceEditor
              Class="code-editor__body"
              Api="CodingProblem.UpdateScript[codingProblemId=ActivityId]"
            >
              {/* 1st: Student's editor */}
              {(styleDisplay) =>
                <AceEditor
