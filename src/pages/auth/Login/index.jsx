    ...
    <div className="auth-wrapper">
      ...
      <div className="page-auth-container">
        <Container className="auth-dialog-container">
          <div className="form-authentication-wrapper">
            <div>
              <h2 className="text-uppercase font-28">Log In</h2>
              <p className="font-18 auth-subheader pb-2">Using Data to Improve Learning Experiences</p>
            </div>
            <div>
              <InputField
                type="email"
            ...
            <div className="d-flex align-items-center justify-content-between pt-5">
              <Link to="/forgotpassword" className="link-cus-primary text-capitalize">
                Forgot Password ?
              </Link>
          ...
          <div className="page-info-section py-3">
            ...
            <div className="mb-4">
              <h3 className="font-24 text-white mb-3">Need an account ?</h3>
              <p className="font-18 text-cus-secondary">Use the request login button to ask your instructor for one</p>
            </div>
            <div className="wide-btn-group gap-4">
              <Link to="/requestlogin" className="btn-auth-secondary">
                REQUEST ACCOUNT
              </Link>
              <Link to="/contactus" className="auth-link-secondary">
                Contact Us
              </Link>
            </div>
          </div>
